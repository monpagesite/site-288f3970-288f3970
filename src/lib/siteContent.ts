...
export const siteContent = {
  ...
  space: {
    label: '空間',
    headline: 'ディテールに宿る哲学',
    subtext: 'ラウンジ空間を形作るすべての要素は、意図的に配置されています。厳選された家具、柔らかな照明、そして職人による手作りの器。すべてが調和し、静寂と温もりを生み出します。',
    gallery: [
      {
        src: 'https://images.unsplash.com/photo-1559496417-e7f25c2e07f4?auto=format&fit=crop&w=1600&q=80',
        alt: 'ラウンジの上質な内装',
        caption: '自然光が差し込む上質な空間',
      },
      {
        src: 'https://images.unsplash.com/photo-1525610553991-2bede1a236e2?auto=format&fit=crop&w=800&q=80',
        alt: 'エスプレッソマシン',
        caption: 'プロフェッショナルな設備',
      },
      {
        src: 'https://images.unsplash.com/photo-1501492193722-de080c46de28?auto=format&fit=crop&w=800&q=80',
        alt: '木製テーブルとレザーチェア',
        caption: '厳選された北欧家具',
      },
      {
  ...
  contact: {
    label: 'お問い合わせ',
    headline: 'お気軽にご来店ください',
    subtext: 'ご質問、ご予約、プライベートイベントのお問い合わせは、お電話またはメールでお気軽にどうぞ。',
    address: {
      title: '所在地',
      line1: '〒150-0001 東京都渋谷区神宮前3-15-8',
      line2: '表参道駅 A2出口より徒歩5分',
    },
    hours: {
      title: '営業時間',
      weekday: '平日：10:00 - 20:00',
      weekend: '週末：09:00 - 21:00',
      closed: '定休日：火曜日',
    },
    contact: {
      title: '連絡先',
    ...
    social: [
      { platform: 'Instagram', handle: '@loungeX_tokyo', url: '#' },
      { platform: 'Facebook', handle: 'loungeX', url: '#' },
    ],
    mapEmbed:
      'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3241.338842047428!2d139.70788!3d35.670269!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzXCsDQwJzEyLjkiTiAxMznCsDQyJzI4LjQiRQ!5e0!3m2!1sen!2sjp!4v1234567890',
  },
